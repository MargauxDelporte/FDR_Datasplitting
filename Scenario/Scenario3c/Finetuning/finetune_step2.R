library(readxl)
tuning <- read_excel("C:/Users/mde4023/Downloads/FDR_Datasplitting/Scenario/Scenario3b/mars_tuning_validresults.xlsx")
tuning=subset(tuning,tuning$power>0.8)
...
###changed param_grid=tuning_grid
tune_mars_hyperparameters2 <- function(
