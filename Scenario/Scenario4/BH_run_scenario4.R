...
source(paste0(mywd,'/Scenario/Scenario4/MarsParallelHD.R'))
...
out_dir <- file.path(mywd, "Scenario/Scenario4/Temp2")
...
for (k in seq_len(nrow(param_grid))) {
  ...
  fname <- sprintf("BH_Results_s%02d_i%02d.csv", s_val, i_val)
