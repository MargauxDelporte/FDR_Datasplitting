...
#eta max_depth gamma lambda alpha   mean_R2
#783  0.050         6   5.0      1     5 0.2753852
#21   0.005         6   0.1      0     1 0.2746961
#863  0.050         6   3.0      5     5 0.2664542
#1251 0.050        10   1.0      1    25 0.2646595
#1781 0.005         6   5.0      1    50 0.2638706
...
# inspect top configs
head(param_grid[order(-param_grid$mean_R2), ], 5)
#eta max_depth gamma min_child_weight colsample_bytree subsample lambda
#16 0.05         6     5                5              1.0       0.8      1
#13 0.05         6     5                5              0.8       0.8      1
#14 0.05         6     5               10              0.8       0.8      1
