# Path to your folder
csv_dir <- "C:/Users/mde4023/Downloads/FDR_Datasplitting/Results/ResultsHD scenario/Temp2"
...
mywd <- paste0(mywd,'/Results/ResultsHD scenario/')
...
PlotPermute
setwd('C:/Users/mde4023/Downloads/FDR_Datasplitting/Results/ResultsHD scenario')
ggsave("HDScenario.png",
       ...
       units  = "in",
       dpi    = 100)
write.xlsx(resultsagg,file='C:/Users/mde4023/Downloads/FDR_Datasplitting/Results/ResultsHD scenario/HDScenarioResults.xlsx')
