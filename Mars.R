...
ApplyMarsTrain<-function(X, y, q,best_nrounds=1000,amountTrain=0.5,amountTest=1-amountTrain,myseed,mybooster='gblinear',num_split=50,signal_index=signal_index){
  set.seed(myseed)
