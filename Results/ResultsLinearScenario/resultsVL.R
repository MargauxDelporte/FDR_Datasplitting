# Path to your folder
csv_dir <- "C:/Users/mde4023/Downloads/FDR_Datasplitting/Results/ResultsLinearScenario/Temp2"
...
mywd <- paste0(mywd,'/Results/ResultsLinearScenario/')
...
PlotPermute
setwd(mywd)
ggsave("LinearScenario.png",
       plot   = PlotPermute,
       width  = 8,
       height = 8/18*8,
       units  = "in",
       dpi    = 100)
write.xlsx(resultsagg,file='C:/Users/mde4023/Downloads/FDR_Datasplitting/Results/ResultsLinearScenario/LinearScenarioResults.xlsx')
